...
let tyrannosaurus = new Dinosaur ({
  name: "tyrannosaurus",
  diet: "carnivorous",
  weight: "7000kg",
  length: "12m",
 ...
 function roar(dinosaur) {
    return `${dinosaur.name} RAWERSRARARWERSARARARRRR!`;
  }

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic

let stegosaurus = new Dinosaur ({
  name: "stegosaurus",
  diet: "herbivorous",
  weight: "2000kg",
  length: "9m",
...
// counldnt use pop total with array functions as it is not an array
